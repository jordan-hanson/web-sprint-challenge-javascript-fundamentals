...
let displayNames = [];
function scientificName(mammal) {
  displayNames += `Name: ${mammal.animal_name}, Scientific: ${mammal.scientific_name} \n.`;
...
let lowCaseAnimalNames = zooAnimals.map(function (mammal) {
  let animalNames = ""
  animalNames = `${mammal.animal_name}`
  return animalNames.toLowerCase();
})
console.log(lowCaseAnimalNames)
...
let lowPopulationAnimals = zooAnimals.filter((mammal) => {
  return mammal.population < 5;
})
console.log(lowPopulationAnimals)
